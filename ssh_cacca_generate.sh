...
# TO TEST USE THIS: 
# uv run --no-sync cacca_generate --model_dir="$CHECKPOINTS_DIR"_test
# OTHERWISE USE THIS:
uv run --no-sync cacca_generate --model_dir="$CHECKPOINTS_DIR" --batch_size=128 --smiles_to_generate=12800
