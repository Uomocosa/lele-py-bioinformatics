...
def test_():
    # pixi run -e cpu python -c "from bio.mlp_train_featurize_v4_1_only_fingerprint import test_; test_()"
    # pixi run -e cuda python -c "from bio.mlp_train_featurize_v4_1_only_fingerprint import test_; test_()"
